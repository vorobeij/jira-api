...
interface WorkflowsApi {
     ...
     * @param createWorkflowDetails, request body
     *
     * @return Unit
     */
    @POST("/rest/api/3/workflow")
    suspend fun createWorkflow(
        @Body createWorkflowDetails: CreateWorkflowDetails
    ): Unit
     ...
     * @param workflowCreateRequest, request body
     *
     * @return WorkflowCreateResponse
     */
    @POST("/rest/api/3/workflows/create")
    suspend fun createWorkflows(
        @Body workflowCreateRequest: WorkflowCreateRequest
     ...
     **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
     * @param workflowName The name of the workflow to be returned. Only one workflow can be specified. (optional) (example: null)
     *
     ...
     * @param workflowName The name of a workflow to return. To include multiple workflows, provide an ampersand-separated list. For example, `workflowName=name1&workflowName=name2`. (optional) (example: null)
     ...
     *  `operations` For each workflow, returns information about the actions that can be undertaken on the workflow. (optional) (example: null)
     * @param queryString String used to perform a case-insensitive partial match with workflow name. (optional) (example: null)
     * @param orderBy [Order](#ordering) the results by a field:

     *  `name` Sorts by workflow name.
     *  `created` Sorts by create time.
     *  `updated` Sorts by update time. (optional) (example: null)
     * @param isActive Filters active and inactive workflows. (optional) (example: null)
     *
     * @return PageBeanWorkflow
     */
    @GET("/rest/api/3/workflow/search")
    suspend fun getWorkflowsPaginated(
        @Query("startAt") startAt: Long = 0,
        @Query("maxResults") maxResults: Int = 50,
        @Query("workflowName") workflowName: List<String>? = null,
     ...
     *  `statuses.usages` Returns the project and issue types that each status is associated with. (optional) (example: null)
     * @param useTransitionLinksFormat Return the new fields (`toStatusReference`/`links`) instead of the deprecated fields (`to`/`from`) for workflow transition port mappings. (optional) (example: null)
     * @param useApprovalConfiguration Return the new field `approvalConfiguration` instead of the deprecated status properties for approval configuration. (optional) (example: null)
     * @param workflowReadRequest, request body
     *
     * @return WorkflowReadResponse
     */
    @POST("/rest/api/3/workflows")
    suspend fun readWorkflows(
        @Query("expand") expand: String? = null,
        @Query("useTransitionLinksFormat") useTransitionLinksFormat: Boolean = false,
        @Query("useApprovalConfiguration") useApprovalConfiguration: Boolean = false,
        @Body workflowReadRequest: WorkflowReadRequest
     ...
     *  `workflows.usages` Returns the project and issue types that each workflow is associated with.
     *  `statuses.usages` Returns the project and issue types that each status is associated with. (optional) (example: null)
     * @param workflowUpdateRequest, request body
     *
     * @return WorkflowUpdateResponse
     */
    @POST("/rest/api/3/workflows/update")
    suspend fun updateWorkflows(
        @Query("expand") expand: String? = null,
        @Body workflowUpdateRequest: WorkflowUpdateRequest
     ...
     *  *Administer Jira* project permission to create all, including global-scoped, workflows
     *  *Administer projects* project permissions to create project-scoped workflows
     * @param workflowCreateValidateRequest, request body
     *
     * @return WorkflowValidationErrorList
     */
    @POST("/rest/api/3/workflows/create/validation")
    suspend fun validateCreateWorkflows(
        @Body workflowCreateValidateRequest: WorkflowCreateValidateRequest
     ...
     *  *Administer Jira* project permission to create all, including global-scoped, workflows
     *  *Administer projects* project permissions to create project-scoped workflows
     * @param workflowUpdateValidateRequestBean, request body
     *
     * @return WorkflowValidationErrorList
     */
    @POST("/rest/api/3/workflows/update/validation")
    suspend fun validateUpdateWorkflows(
        @Body workflowUpdateValidateRequestBean: WorkflowUpdateValidateRequestBean
    ): WorkflowValidationErrorList
     ...
     * @param workflowId null (optional) (example: null)
     * @param projectId null (optional) (example: null)
     * @param issueTypeId null (optional) (example: null)
     *
     * @return WorkflowCapabilities
     */
    @GET("/rest/api/3/workflows/capabilities")
    suspend fun workflowCapabilities(
