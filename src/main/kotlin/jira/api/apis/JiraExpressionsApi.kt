...
interface JiraExpressionsApi {
     ...
     *  `complexity` EXPERIMENTAL. Determines the formulae for how many [expensive operations](https://developer.atlassian.com/cloud/jira/platform/jira-expressions/#expensive-operations) each expression may execute. (optional) (example: null)
     * @param jiraExpressionForAnalysis, request body
     *
     ...
     * @param expand Use [expand](#expansion) to include additional information in the response. This parameter accepts `meta.complexity` that returns information about the expression complexity. For example, the number of expensive operations used by the expression and how close the expression is to reaching the [complexity limit](https://developer.atlassian.com/cloud/jira/platform/jira-expressions/#restrictions). Useful when designing and debugging your expressions. (optional) (example: null)
     * @param jiraExpressionEvaluateRequestBean, request body
     *
     * @return JExpEvaluateJiraExpressionResultBean
     */
    @POST("/rest/api/3/expression/evaluate")
    suspend fun evaluateJSISJiraExpression(
        @Query("expand") expand: String? = null,
        @Body jiraExpressionEvaluateRequestBean: JiraExpressionEvaluateRequestBean
    ...
    Permission to access Jira Software is required to access Jira Software context variables (`board` and `sprint`) or fields (for example, `issue.sprint`).
     * @param expand Use [expand](#expansion) to include additional information in the response. This parameter accepts `meta.complexity` that returns information about the expression complexity. For example, the number of expensive operations used by the expression and how close the expression is to reaching the [complexity limit](https://developer.atlassian.com/cloud/jira/platform/jira-expressions/#restrictions). Useful when designing and debugging your expressions. (optional) (example: null)
     * @param jiraExpressionEvalRequestBean, request body
     *
     * @return JiraExpressionResult
     */
    @POST("/rest/api/3/expression/eval")
    suspend fun evaluateJiraExpression(
        @Query("expand") expand: String? = null,
        @Body jiraExpressionEvalRequestBean: JiraExpressionEvalRequestBean
