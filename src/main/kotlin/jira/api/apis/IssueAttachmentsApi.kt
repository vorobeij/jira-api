...
import jira.api.models.Attachment
import jira.api.models.AttachmentArchiveImpl
import jira.api.models.AttachmentArchiveMetadataReadable
import jira.api.models.AttachmentMetadata
import jira.api.models.AttachmentSettings
import jira.api.models.MultipartFile
...
interface IssueAttachmentsApi {
     ...
     * @param issueIdOrKey The ID or key of the issue that attachments are added to.  (example: null)
     ...
     * @param id The ID of the attachment.  (example: null)
     * @param redirect Whether a redirect is provided for the attachment download. Clients that do not automatically follow redirects can set this to `false` to avoid making multiple requests to download the attachment. (optional) (example: null)
     * @param fallbackToDefault Whether a default thumbnail is returned when the requested thumbnail is not found. (optional) (example: null)
