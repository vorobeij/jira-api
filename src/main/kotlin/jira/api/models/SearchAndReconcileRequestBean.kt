 ...
 * @param maxResults, optional, The maximum number of items to return. Depending on search criteria, real number of items returned may be smaller. It returns max 5000 issues
 ...
 * @param reconcileIssues, optional, Strong consistency issue ids to be reconciled with search results. Accepts max 50 ids. All issues must exist.
 */
@Serializable
data class SearchAndReconcileRequestBean(
    ...
    @SerialName("reconcileIssues") val reconcileIssues: List<Long>? = null
)