...
/**
 *
 * @param categorisedActors, optional, The actors to add to the project role.
 ...
 * @param id, optional, The ID of the project role. Use [Get all project roles](#api-rest-api-3-role-get) to get a list of project role IDs.
 */
@Serializable
data class ProjectRoleActorsUpdateBean(
    @SerialName("categorisedActors") val categorisedActors: categorisedActors? = null,
