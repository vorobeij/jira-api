 ...
 */
@Serializable
data class PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects(
    ...
    @SerialName("values") val values: List<PrioritySchemeWithPaginatedPrioritiesAndProjects>? = null
)