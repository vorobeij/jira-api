 ...
 *
 * @param contexts, optional, List of contexts of the UI modification. The maximum number of contexts is 1000. If provided, replaces all existing contexts.
 ...
 * @param name, optional, The name of the UI modification. The maximum length is 255 characters.
 */
@Serializable
data class UpdateUiModificationDetails(
