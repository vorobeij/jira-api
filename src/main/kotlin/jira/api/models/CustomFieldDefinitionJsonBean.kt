...
/**
 *
 * @param description, optional, The description of the custom field, which is displayed in Jira.
 * @param name, required, The name of the custom field, which is displayed in Jira. This is not the unique identifier.
 * @param searcherKey, optional, The searcher defines the way the field is searched in Jira. For example, *com.atlassian.jira.plugin.system.customfieldtypes:grouppickersearcher*.
 ...
 * @param type, required, The type of the custom field. These built-in custom field types are available:
